...
let bankProperties: [Banks: BankProperties] = [
    ...
    .bradesco: BankProperties(text: "BRAD", textSize: 15, backgroundColor: .red, labelBankColor: .white),
    ...
    .bancoDoBrasil: BankProperties(text: "Banco Brasil", textSize: 14, backgroundColor: .yellow, labelBankColor: .blue)
]
